...
3. [Hosting & Deployment Guide](#hosting--deployment-guide)
4. [Editing content](#editing-content)
5. [Current architecture](#current-architecture)
6. [Content architecture](#content-architecture)
7. [Abstraction layers](#abstraction-layers)
8. [Future CMS migration guide](#future-cms-migration-guide)
9. [Future API migration guide](#future-api-migration-guide)
10. [Database migration guide](#database-migration-guide)
11. [Schema evolution](#schema-evolution)
12. [Long-term maintenance guide](#long-term-maintenance-guide)
13. [Resume management](#resume-management)
14. [Backup strategy](#backup-strategy)
15. [Architecture Decision Records](#architecture-decision-records)
16. [Future expansion roadmap](#future-expansion-roadmap)
17. [Developer onboarding](#developer-onboarding)
18. [Tests](#tests)
19. [Competitive Programming](#competitive-programming)
